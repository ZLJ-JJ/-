 ...
 * @LastEditTime: 2021-08-13 10:00:37
...
<template>
  <div class="u-waterfall">
    <div id="u-left-column" class="u-column wate_left">
...
/**
 * waterfall 瀑布流
 * @description 这是一个瀑布流形式的组件，内容分为左右两列，结合udiv的懒加载组件效果更佳。相较于某些只是奇偶数左右分别，或者没有利用vue作用域插槽的做法，udiv的瀑布流实现了真正的 组件化，搭配LazyLoad 懒加载和loadMore 加载更多组件，让您开箱即用，眼前一亮。
 * @tutorial https://www.udivui.com/components/waterfall.html
...
export default {
  ...
  methods: {
    splitData() {
      ...
      let leftRect = document.querySelectorAll("#u-right-column");
      let rightRect = document.querySelectorAll("#u-right-column");
