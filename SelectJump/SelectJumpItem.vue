 ...
 * @LastEditTime: 2021-08-10 14:36:17
...
<template>
  ...
  >
    ...
    <div class="u-cell__value" :style="[valueStyle]">
      <div class="u-cell__value" v-if="value">{{ value }}</div>
      <slot v-else></slot>
    </div>
    <div class="flex u-cell_right" v-if="$slots['right-icon']">
