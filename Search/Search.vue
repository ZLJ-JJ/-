  ...
  >
    ...
    >
      ...
      <input
        ...
        :placeholder-style="`color: ${placeholderColor};padding-left:18px`"
        class="u-input"
        type="text"
        :style="[
          {
    ...
    <!-- 清仓环境不需要文字 -->
    <!-- 	<div :style="[actionStyle]" class="u-action" 
			:class="[showActionBtn || show ? 'u-action-active' : '']" 
			@click.stop.stop.prevent="custom"
		>{{ actionText }}</div> -->
  </div>
</template>
 ...
 * @tutorial https://www.udivui.com/components/search.html
